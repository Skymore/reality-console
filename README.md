...
verification `pending`. Control Service migrations 9 and 10 now own durable member accounts, atomic
multi-node assignments, authoritative full-snapshot compilation, per-node credential rotation,
